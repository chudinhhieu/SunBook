...
public class AdapterSpinerThanhVien extends BaseAdapter {
    Context context;
    ArrayList<ThanhVien> list;

    public AdapterSpinerThanhVien(Context context, ArrayList<ThanhVien> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewOfItem.tvTenLoaiSach.setText(list.get(i).getHoTen());
        return view;
    }
